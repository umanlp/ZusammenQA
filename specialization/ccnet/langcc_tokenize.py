...
if __name__ == '__main__':
    #python langcc_tokenize.py --input_file="./test/cc100_ja_test.txt" --save_file_name="./test/cc100_ja_test_prep.txt" --lang="ja"
    #python langcc_tokenize.py --input_file="./train/cc100_ja_train.txt" --save_file_name="./train/cc100_ja_train_prep.txt" --lang="ja"
    args = parse_args()
