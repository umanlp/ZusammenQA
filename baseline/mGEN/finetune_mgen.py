...
class GenerativeQAModule(BaseTransformer):
    ...
    def __init__(self, hparams, **kwargs):
        ...
        config = config_class.from_pretrained(hparams.model_name_or_path, cache_dir = "/work-ceph/wifo3/transformers")
        ...
        model = self.model_class.from_pretrained(
            hparams.model_name_or_path, config=config, cache_dir = "/work-ceph/wifo3/transformers")
        ...
        # else:
        tokenizer = AutoTokenizer.from_pretrained(hparams.model_name_or_path, cache_dir = "/work-ceph/wifo3/transformers")
