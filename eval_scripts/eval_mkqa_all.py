...
dev_mkqa_lang = ['ar', 'en', 'es', 'fi', 'ja', 'km', 'ko', 'ms', 'ru', 'sv', 'tr', 'zh_cn'] #data_dir = "./data/eval/mkqa_dev", pred_dir = "./data/baselines/baseline2/mkqa_baseline2_pred"
test_mkqa_lang = ['ar', 'en', 'es', 'fi', 'ja', 'km', 'ko', 'ms', 'pt', 'ru', 'sv', 'tr', 'zh_cn']
